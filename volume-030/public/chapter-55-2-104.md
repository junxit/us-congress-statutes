...
- March 30, 1898.
- Nebraska, Kansas and Gulf Railway may build, etc., railway line through Indian and Oklahoma Territories.
- Location.
- Right of way.
- —width.
- Land for stations.
- —additional.
- Proviso. Limit.
- Lands not to be leased; restricted use, etc.
- —reversion.
- Damages.
- Referees.
- —appointment.
- —oath, etc.
- Hearings.
- Proviso. Place of hearings, etc.
- Compensation.
- Witnesses.
- —fees.
- Costs.
- Appeal.
- —to district court, Indian Territory.
- Measure of damages.
- —costs.
...
- Provisos. Appeal by general councils of tribes, etc.
- —ante, p. 347.
...
- Record of mortgages.
- Amendment.
- Assignment of right of way, etc.
