...
## § 3. ESTABLISHMENT OF COMPUTER STANDARDS PROGRAM.
...
- **(2)** by redesignating section 20 as section 22, and by inserting after section 19 the following new sections:
  > ## § 20.
  >
  > - **(a)** The National Bureau of Standards shall—
  ...
  > - **(c)** For the purposes of— the National Bureau of Standards shall draw upon computer system technical security guidelines developed by the National Security Agency to the extent that the National Bureau of Standards determines that such guidelines are consistent with the requirements for protecting sensitive information in Federal computer systems.
  ...
  >   - **(1)** of the initial members, three shall be appointed for terms of one year, three shall be appointed for terms of two years, three snail be appointed for terms of three years, and three shall be appointed for terms of four years; and
...
- **(3)** by adding at the end thereof the following new section:
  > ## § 23.
  >
  > This Act may be cited as the National Bureau of Standards Act.”.

## § 4. AMENDMENT TO BROOKS ACT.
...
## § 5. FEDERAL COMPUTER SYSTEM SECURITY TRAINING.
...
## § 6. ADDITIONAL RESPONSIBILITIES FOR COMPUTER SYSTEMS SECURITY AND PRIVACY.
...
## § 8. RULES OF CONSTRUCTION OF ACT.
