...
- February 13, 1925. [S. J. Res. 174.] [Pub. Res. No. 50.]
- District of Columbia. Inauguration of the President. Use of reservations, etc., authorized.
- Provisos. Condition.
- Streets, avenues, etc.
- Supervision of stands, etc.
- Removal of structures, etc.
- Overhead wires may be used for illumination.
- Provisos. Supervision of work.
- Time limit for use, etc.
- Safety precautions.
- No expense to United States or District.
- Loans of flags, etc., for decorations.
- Provisos. Time limit.
- Indemnity for damage, etc.
- Loan of tents, etc.
- Indemnity for damages, etc.
- Temporary overhead telegraph wires permitted.
