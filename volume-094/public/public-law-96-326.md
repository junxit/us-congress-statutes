...
That section 1004 of title 39, United States Code, is amended by adding at the end thereof the following new subsections:
...
>     - **(A)** give the supervisors’ organization details of its decision to implement the program, together with the information upon winch the decision is based;
...
>   - **(3)** If a program described in paragraph (1) of this subsection is implemented, the Postal Service snail—
...
>   - **(1)** ‘supervisors’ organization’ means the organization recognized by the Postal Service under subsection (b) of this section as representing a majority of supervisors; and
...
- Aug. 8, 1980 [H.R. 827]
- Postal Service dispute resolution.
- Supervisory organization.
- Pay policy proposals.
- 39 USC 1203.
- Federal Mediation and Conciliation Service, factfinding panel.
- Panel selection.
- 39 USC 1003, 1004.
- Cost of panel.
- Review panel.
- 39 USC 1003. Recommendations to Congress. Definitions.
...
- Vol, 126 (1980): July 25, considered and passed Senate, amended.
