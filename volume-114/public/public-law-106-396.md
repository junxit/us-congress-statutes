---
volume: 114
citation: 114 Stat. 1637
type: Public Law
number: 396
congress: 106
scope: public
approved: 2000-10-30
bills: 106/hr-3767, 106/s-2367
---
...
## § 101. ELIMINATION OF PILOT PROGRAM STATUS.
...
## § 201. EXTENSION OF RECIPROCAL PRIVILEGES.

Section 217(a)(2)(A) of the Immigration and Nationality Act 8 U.S.C. 1187(a)(2)(A)) is amended by inserting “

> , either on its own or in conjunction with one or more other countries that are described in subparagraph (B) and that have established with it a common area for immigration admissions,” after “

> to extend)”.

## § 202. MACHINE READABLE PASSPORT PROGRAM.

- **(a)** *Requirement on Alien.—* Section 217(a) of the Immigration and Nationality Act (8 U.S.C. 1187(a)) is amended— by redesignating paragraphs (3) through (7) as paragraphs (4) through (8), respectively; and by inserting after paragraph (2) the following:
  > - **(3)** *Machine readable passport.—* On and after October 1, 2007, the alien at the time of application for admission is in possession of a valid unexpired machine-readable passport that satisfies the internationally accepted standard for machine readability.”.
...
## § 203. DENIAL OF PROGRAM WAIVER BASED ON GROUND OF INADMISSIBILITY.
...
## § 204. EVALUATION OF EFFECT OF COUNTRY’S PARTICIPATION ON LAW ENFORCEMENT AND SECURITY.
...
- **(b)** *Continuation of Designation.—* Section 217(c) of the Immigration and Nationality Act (8 U.S.C. 1187(c)) is amended by adding at the end the following:
  ...
  >       - **(II)** shall determine, based upon the evaluation in subclause (I), whether any such designation ought to be continued or terminated under subsection (d); and
  ...
  >     - **(ii)** *Effective date.—* A termination of the designation of a country under this subparagraph shall take effect on the date determined by the Attorney General, in consultation with the Secretary of State.
  ...
  >     - **(iii)** *Redesignation.—* The Attorney General may redesignate the country as a program country, without regard to subsection (f) or paragraph (2) or (3), when the Attorney General, in consultation with the Secretary of State, determines that—
...
## § 205. USE OF INFORMATION TECHNOLOGY SYSTEMS.
...
## § 206. CONDITIONS FOR VISA REFUSAL ELIGIBILITY.
...
## § 301. MAINTENANCE OF NONIMMIGRANT AND SPECIAL IMMIGRANT STATUS NOTWITHSTANDING INTELSAT PRIVATIZATION.
...
- **(c)** *Special Immigrants.—* For purposes of section 101(a)(27)(I) (8 U.S.C. 1101(a)(27)(D) of the Immigration and Nationality Act, the term “international organization” includes INTELSAT or any successor or separated entity of INTELSAT.

## § 302. TREATMENT OF EMPLOYMENT FOR PURPOSES OF OBTAINING IMMIGRANT STATUS AS A MULTINATIONAL EXECUTIVE OR MANAGER.
...
## § 401. AMENDMENT TO SECTION 214 OF THE IMMIGRATION AND NATIONALITY ACT.
...
## § 402. THE IMMIGRANT INVESTOR PILOT PROGRAM.
...
## § 403. PARTICIPATION OF BUSINESS AIRCRAFT IN THE VISA WAIVER PROGRAM.
...
- **(e)** *Report Required.—* Not later than two years after the date of the enactment of this Act, the Attorney General shall submit a report to the Committees on the Judiciary of the House of Representatives and the Senate assessing the effectiveness of the program implemented under the amendments made by this section for simplifying the admission of business travelers from visa waiver program countries and compliance with the Immigration and Nationality Act by such travelers under that program.

## § 404. MORE EFFICIENT COLLECTION OF INFORMATION FEE.
...
- **(4)** in paragraph (4)—
  ...
  - **(B)** by adding at the end of subparagraph (B) the following new sentence: “
    > Such expenses include, but are not necessarily limited to, those incurred by the Secretary of State in connection with the program under subsection (a).”; and
...
## § 405. NEW TIME-FRAME FOR IMPLEMENTATION OF DATA COLLECTION PROGRAM.
