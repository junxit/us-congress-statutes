---
volume: 114
citation: 114 Stat. 762
type: Public Law
number: 265
congress: 106
scope: public
approved: 2000-09-19
bills: 106/hr-4040, 106/s-2420
---
...
- **(a)** *In General.—* Subpart G of part III of title 5, United States Code, is amended by adding at the end the following:
  ...
  >
  > - **(1)** *Employee.—* The term ‘employee’ means— but does not include an individual employed by the government of the District of Columbia.
  ...
  > - **(b)** *General Requirements.—* Long-term care insurance may not be offered under this chapter unless—
  ...
  > - **(c)** *Documentation Requirement.—* As a condition for obtaining long-term care insurance coverage under this chapter based on one’s status as a qualified relative, an applicant shall provide documentation to demonstrate the relationship, as prescribed by the Office.
...
- **(b)** *Conforming Amendment.—* The analysis for part III of title 5, United States Code, is amended by adding at the end of subpart G the following:
...
## TITLE II — FEDERAL RETIREMENTCOVERAGE ERRORS CORRECTION

## § 2001. SHORT TITLE; TABLE OF CONTENTS.
...
- **(b)** *Table of Contents.—* The table of contents for this title is as follows:
  ...
  > - Chapter 5— Employee Who Should Have Been CSRS-Offset Covered, butWho Was Erroneously CSRS Covered Instead
  > - Sec. 2141. Applicability.
  > - Sec. 2142. Correction mandatory.
  > - Chapter 6— Employee Who Should Have Been CSRS Covered, but Who WasErroneously CSRS-Offset Covered Instead
...
- **(12)** *OASDI employee tax.—* The term “OASDI employee tax” means the tax imposed under section 3101(a) of the Internal Revenue Code of 1986 (relating to Old-Age, Survivors and Disability Insurance).
- **(13)** *OASDI employer tax.—* The term “OASDI employer tax” means the tax imposed under section 3111(a) of the Internal Revenue Code of 1986 (relating to Old-Age, Survivors and Disability Insurance).
...
- **(a)** *In general.—* This title shall apply with respect to retirement coverage errors that occur before, on, or after the date of the enactment of this Act.
...
## § 2004. IRREVOCABILITY OF ELECTIONS.
...
- **(b)** *Coverage.—*
  - **(1)** *Election.—* Not later than 180 days after the date of the enactment of this Act, the Office shall prescribe regulations authorizing an individual described under subsection (a) to elect CSRS-Offset coverage or FERS coverage, effective as of the date of the retirement coverage error.
...
## § 2121. EMPLOYEE WHO SHOULD BE SOCIAL SECURITY-ONLY COVERED, BUT WHO IS ERRONEOUSLY CSRS OR CSRS-OFFSET COVERED INSTEAD.
...
## § 2131. EMPLOYEE WHO SHOULD BE SOCIAL SECURITY-ONLY COVERED, CSRS COVERED, OR CSRS-OFFSET COVERED AND IS NOT FERS-ELIGIBLE, BUT WHO IS ERRONEOUSLY FERS COVERED INSTEAD.
...
- **(b)** *Uncorrected Error.—*
  ...
  - **(2)** *Coverage.—*
    - **(A)** *Election.—*
      ...
      - **(ii)** *Treatment offers election.—* An election of FERS coverage under this subsection is deemed to be an election under section 301 of the Federal Employees Retirement System Act of 1986 (5 U.S.C. 8331 note; Public Law 99–335; 100 Stat. 599).
...
- **(c)** *Corrected Error.—*
  ...
  - **(2)** Election.—Not later than 180 days after the date of the enactment of this Act, the Office shall prescribe regulations authorizing individuals to elect, during the 18-month period immediately following the effective date of such regulations to remain Social Security-Only covered. CSRS covered, or CSRS-Offset covered, or to be FEES covered, effective as of the date of the retirement coverage error.
  ...
  - **(4)** *Treatment offers election.—* An election of FERS coverage under this subsection is deemed to be an election under section 301 of the Federal Employees Retirement System Act of 1986 (5 U.S.C. 8331 note; Public Law 99–335; 100 Stat. 599).

## § 2132. FERS-ELIGIBLE EMPLOYEE WHO SHOULD HAVE BEEN CSRS COVERED, CSRS-OFFSET COVERED, OR SOCIAL SECURITY-ONLY COVERED, BUT WHO WAS ERRONEOUSLY FERS COVERED INSTEAD WITHOUT AN ELECTION.

- **(a)** *In General.—*
  - **(1)** *FERS election prevented.—* If an individual was prevented from electing FERS coverage because the individual was erroneously FERS covered during the period when the individual was eligible to elect FERS under title III of the Federal Employees Retirement System Act or the Federal Employees’ Retirement System Open Enrollment Act of 1997 (Public Law 105–61; 111 Stat. 1318 et seq.), the individual—
...
## § 2201. IDENTIFICATION AND NOTIFICATION REQUIREMENTS.
...
## § 2202. INFORMATION TO BE FURNISHED TO AND BY AUTHORITIES ADMINISTERING THIS TITLE.
...
## § 2204. PROVISIONS RELATED TO SOCIAL SECURITY COVERAGE OF MISCLASSIFIED EMPLOYEES.
...
- **(b)** *Reports to Commissioner of Social Security.—*
  - **(1)** *In general.—* In order to carry out the Commissioner of Social Security’s responsibilities under title II of the Social Security Act, the Commissioner may request the head of each agency that employs or employed a covered individual to report (in coordination with the Office of Personnel Management) in such form and within such timeframe as the Commissioner may specify, any or all of—
    - **(A)** the total wages (as defined in section 3121(a) of the Internal Revenue Code of 1986) paid to such individual during each year of the entire period of the erroneous CSRS coverage; and
  ...
  - **(3)** *Wages.—* For purposes of section 201 of the Social Security Act (42 U.S.C. 401), wages reported under this subsection shall be deemed to be wages reported to the Secretary of the Treasury or the Secretary’s delegates pursuant to subtitle F of the Internal Revenue Code of 1986.
...
- **(d)** *Payment of OASDI Employer Taxes.—*
  - **(1)** *In general.—* Each employing agency shall pay an amount equal to the OASDI employer taxes owed with respect to covered individuals during the applicable period of erroneous coverage (as adjusted by amounts transferred for the payment of such taxes as a result of corrections made, including corrections made before the date of the enactment of this Act).
  - **(2)** *Payment.—* Amounts paid under this subsection shall be determined subject to any limitation under section 6501 of the Internal Revenue Code of 1986.

## § 2205. THRIFT SAVINGS PLAN TREATMENT FOR CERTAIN INDIVIDUALS.
...
## § 2206. CERTAIN AGENCY AMOUNTS TO BE PAID INTO OR REMAIN IN THE CSRDF.
...
## § 2207. CSRS COVERAGE DETERMINATIONS TO BE APPROVED BY OPM.
...
## § 2208. DISCRETIONARY ACTIONS BY DIRECTOR
...
- **(e)** *Report.—* The Office of Personnel Management shall, not later than 180 days after the date of the enactment of this Act, and annually thereafter for each year in which the authority provided in this section is used, submit a report to each House of Congress on the operation of this section.
...
## § 2301. PROVISIONS TO AUTHORIZE CONTINUED CONFORMITY OF OTHER FEDERAL RETIREMENT SYSTEMS.
...
## § 2302. AUTHORIZATION OF PAYMENTS.
...
## § 2303. INDIVIDUAL RIGHT OF ACTION PRESERVED FOR AMOUNTS NOT OTHERWISE PROVIDED FOR UNDER THIS TITLE.
...
Except as otherwise provided in this title, this title shall take effect on the date of the enactment of this Act.
...
- July 25, considered and passed Senate, amended, in lieu of S. 2420.
- July 27, House concurred in Senate amendments with amendments.
