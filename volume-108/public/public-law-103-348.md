...
## § 3. FEDERAL PRINTING REQUIREMENTS.
...
- **(b)** *Exceptions.—*
  - **(1)** *Exceptions.—* Subsection (a) shall not apply to lithographic printing performed or procured by a Federal agency, that the cost of performing the printing using vegetable oil-based ink is significantly greater than the cost of performing the printing using other available ink.
...
- Oct. 6, 1994 [S. 716]
- Vegetable Ink Printing Act of 1994. 44 USC 501 note.
- 44 USC 501 note.
- Reports.
...
- Vol. 140 (1994): Sept. 20, considered and passed House, amended.
