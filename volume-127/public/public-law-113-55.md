...
This title may be cited as the “Prematurity Research Expansion and Education for Mothers who deliver Infants Early Reauthorization Act” or the “PREEMIE Reauthorization Act”.

## § 102. RESEARCH AND ACTIVITIES AT THE CENTERS FOR DISEASE CONTROL AND PREVENTION.
...
## § 103. ACTIVITIES AT THE HEALTH RESOURCES AND SERVICES ADMINISTRATION.
...
- **(b)** *Public and Health Care Provider Education.—* Section 399Q of the Public Health Service Act (42 U.S.C. 280g–5) is amended—
  - **(1)** in subsection (b)—
    - **(A)** in paragraph (1), by striking subparagraphs (A) through (F) and inserting the following:
      ...
      > - **(F)** utilization of evidence-based strategies to prevent birth injuries;”; and
...
This title may be cited as the “National Pediatric Research Network Act of 2013”.

## § 202. NATIONAL PEDIATRIC RESEARCH NETWORK.
...
- **(2)** by inserting after subsection (c) the following:
  ...
  >     - **(B)** other consortia, centers, or networks focused on pediatric research that are recognized by the Director of NIH and established pursuant to the authorities vested in the National Institutes of Health by other sections of this Act.
...
- **(a)** *In General.—* Section 404K(g) of the Public Health Service Act (42 U.S.C. 283m(g)) is amended—
  ...
  - **(4)** in paragraph (2), as so redesignated—
    - **(A)** by striking “With respect to amounts reserved under paragraph (1)” and inserting “With respect to amounts authorized to be appropriated by paragraph (1)”; and
    - **(B)** by striking “board of directors” and inserting “Secretary in consultation with the board of directors”.
- **(b)** *GAO Study.—* Not later than 2 years after the date of enactment of this Act, the Comptroller General of the United States shall conduct an independent evaluation, and submit to the appropriate committees of Congress a report, regarding chimpanzees under the ownership or control the National Institutes of Health. Such report shall review and assess—
  ...
  - **(2)** the cost for the care, maintenance, and transportation of such chimpanzees, including the cost broken down by—
    - **(A)** research or retirement status;
    - **(B)** services included in the care, maintenance, and transportation; and
    - **(C)** location;
  - **(3)** the extent to which matching requirements have been met pursuant to section 404K(e)(4) of the Public Health Service Act (42 U.S.C. 283m(e)(4)); and
  - **(4)** any options for cost savings for the support and maintenance of such chimpanzees.
- **(c)** *Biennial Report.—* Section 404K(g) of the Public Health Service Act (42 U.S.C. 283m(g)) is amended by adding at the end the following:
...
- Nov. 27, 2013 [S. 252]
- Prematurity Research Expansion and Education for Mothers who deliver Infants Early Reauthorization Act. 42 USC 201 note.
- 42 USC 247b–4f note.
- Deadline.
- National Pediatric Research Network Act of 2013. 42 USC 201 note.
- Reports.
