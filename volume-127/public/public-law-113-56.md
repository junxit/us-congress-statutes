...
> An Act To extend authorities related to global HIV/AIDS and to promote oversight of United States programs.
...
- **(a)** *Annual Study; Message.—* Section 101(g) of the United States Leadership Against HIV/AIDS, Tuberculosis, and Malaria Act of 2003 (22 U.S.C. 7611(g)) is amended—
  ...
  - **(3)** by inserting after paragraph (1) the following new paragraph:
    ...
    >     - **(ii)** where providing such comparable data is not currently practicable, an explanation of why it is not currently practicable, and when it will be practicable.”; and
  ...
  - **(1)** in paragraph (5)—
    ...
    - **(E)** in subparagraph (F)—
      ...
      - **(ii)** by striking clause (ii) and inserting the following new clauses:
        ...
        > - **(iv)** high-quality grant performance evaluations measuring inputs, outputs, and outcomes, as appropriate, with the goal of achieving outcome reporting;”; and
...
- Dec. 2, 2013 [S. 1545]
- PEPFAR Stewardship and Oversight Act of 2013. 22 USC 7601 note.
- Deadlines.
- Web posting.
- President.
