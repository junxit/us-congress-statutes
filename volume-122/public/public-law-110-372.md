...
> An Act To modify pay provisions relating to certain senior-level positions in the Federal Government, and for other purposes.
...
- **(a)** *Locality Pay.—* Section 5304 of title 5, United States Code, is amended—
  - **(1)** in subsection (g), by amending paragraph (2) to read as follows:
    ...
    >   - **(B)** any positions under subsection (h)(1)(C) as the President may determine.”; and
    ...
    - **(A)** in paragraph (1)—
      ...
      - **(ii)** in subparagraph (D)—
        ...
        - **(III)** by adding at the end the following:
          > - **(vii)** a position to which section 5376 applies (relating to certain senior-level and scientific and professional positions).”; and
...
- **(b)** *Access to Higher Maximum Rate of Basic Pay.—* Section 5376(b) of title 5, United States Code, is amended—
  - **(1)** in paragraph (1), by striking subparagraph (B) and inserting the following:
    > - **(B)** subject to paragraph (3), not greater than the rate of basic pay payable for level III of the Executive Schedule.”; and
...
- **(c)** *Authority for Employment; Appointments; Classification Standards.—* Title 5, United States Code is amended—
  ...
  - **(3)** in section 3325—
    ...
    - **(B)** by adding at the end the following:
      > - **(c)** The Director of the Office of Personnel Management shall prescribe such regulations as may be necessary to carry out the purpose of this section.”; and
