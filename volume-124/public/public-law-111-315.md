...
> An Act To amend the Water Resources Development Act of 2000 to extend and modify the program allowing the Secretary of the Army to accept and expend funds contributed by non-Federal public entities to expedite the evaluation of permits, and for other purposes.
...
- **(3)** by striking subsection (b) and inserting the following:
  ...
  > - **(d)** *Public Availability.—* The Secretary shall ensure that all final permit decisions carried out using funds authorized under this section are made available to the public, including on the Internet.”; and
