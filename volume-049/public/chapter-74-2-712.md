...
- June 22, 1936. [S. J. Res. 273.] [Pub. Res., No. 119.]
- Presidential inaugural ceremonies, 1937. Use of reservations, etc., in the District of Columbia, authorized.
- Provisos. Condition.
- Supervision of stands, etc.
- Prompt removal of structures, etc.
- Overhead conductors for illuminations.
- Provisos. Supervision.
- Time limitation.
- Safety precautions, etc.
- No Federal or local expense or damage.
- Loan of tents, flags, etc.
- Provisos. Time limit of loan.
- Indemnity for damage, etc.
- Loan of hospital tents, supplies, etc.
- Temporary extension of telegraph, telephone, etc., wires permitted.
