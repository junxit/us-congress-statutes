...
> JOINT RESOLUTION To amend Public Law Numbered 623, approved June 22, 1942, entitled “Joint resolution to codify and emphasize existing rules and customs pertaining to the display and use of the flag of the United States of America”.
...
- **(g)** The flag should be displayed during school days in or near every school house.
...
- **(i)** The flag should never be used for advertising purposes in any manner whatsoever. It should not be embroidered on such articles as cushions or handkerchiefs and the like, printed or otherwise impressed on paper napkins or boxes or anything that is designed for temporary use and discard; or used as any portion of a costume or athletic uniform. Advertising signs should not be fastened to a staff or halyard from which the nag is flown.
- **(j)** The flag, when it is in such condition that it is no longer a fitting emblem for display, should be destroyed hi a dignified way, preferably by burning.
...
- December 22, 1942 [H. J. Res. 359] [Public Law 829]
- Flag of the U. S. A. Display and use. Ante, p. 377.
- Open-air display. Customary time.
...
- Polling places.
- Schoolhouses.
- Position when carried with other flags.
- Parade floats.
- Vehicles, trains, and boats.
- Position with other flags; exception.
- Crossed staffs.
- Position when grouped.
- Displayed with State, city, etc., flags.
- Flags of two or more nations.
- Displayed from projecting staff.
- Suspension over sidewalk.
- Without staff.
- Suspension over middle of street.
- On a speaker’s platform. In a church or public auditorium.
- Unveiling a statue or monument.
- Half staff.
- Crepe streamers.
- Covering a casket.
- Disrespect. Restrictions on use.
- Distress signal.
- Use as drapery, festoon, etc. Bunting.
- Care of flag.
- Marks, insignia, designs, etc.
- Use for advertising or novelty purposes.
- Destruction when unfit for display.
- Salute to flag.
- When national anthem is played.
- Pledge of allegiance.
- Alteration of rules, etc., by proclamation.
