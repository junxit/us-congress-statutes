...
> An Act Making appropriations for the Department of the Interior, environment, and related agencies for the fiscal year ending September 30, 2019, and for other purposes.
...
## § 101. AMENDMENTS TO THE PAYCHECK PROTECTION PROGRAM, ECONOMIC INJURY DISASTER LOANS, AND EMERGENCY GRANTS.
...
- **(d)** *Set Aside for Insured Depository Institutions, Credit Unions, and Community Financial Institutions.—* Section 7(a)(36) of the Small Business Act (15 U.S.C. 636(a)(36)) is amended—
  - **(1)** in subparagraph (A)—
    - **(A)** in clause (viii), by striking “and” at the end;
    - **(B)** in clause (ix), by striking the period at the end and inserting a semicolon; and
    - **(C)** by adding at the end the following:
      ...
      > - **(xii)** the term ‘credit union’ means a State credit union or a Federal credit union, as those terms are defined, respectively, in section 101 of the Federal Credit Union Act (12 U.S.C. 1752).”; and
...
- Apr. 24, 2020 [H.R. 266]
- Paycheck Protection Program and Health Care Enhancement Act. 15 USC 9001 note.
- Ante, p. 293.
- Ante, p. 301.
- Ante, p. 308.
- Ante, p. 306.
...
- Reports. Data.
- Analysis.
- Coordination. Reports. Testing plan.
- Testing estimates and guidelines.
- Applicability.
- Consultation.
