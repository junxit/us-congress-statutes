...
> An Act To reauthorize the SBIR and STTR programs and pilot programs, and for other purposes.
...
- **(1)** in subsection (b)(7), by adding at the end the following:
  ...
  > - **(L)** the aggregate number and dollar amount of SBIR and STTR awards made pursuant to waivers under subsection (qq)(3)(E), provided that the Administrator does not publish any personally identifiable information, the identity of each such small business concern, or any otherwise sensitive information;”; and
...
- Coordination.
- Definition.
- Deadlines. 15 USC 638 note.
- Deadline. Consultations. 15 USC 638 note.
- Deadline. Time period. Reports.
- Requirement.
- Time period.
- Review. Determination. Records. Time period.
- Determination.
- China.
- Requirements.
- Repayment.
...
- Analyses.
- Deadline.
- Time period. Public information.
- Assessment.
- Time periods.
...
- Reports.
- Processes.
- Deadline. Reports. Public information. Time periods. Analyses.
- Evaluation.
- Recommenda- tions.
- Evaluations.
- Compliance.
